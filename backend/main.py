...
async def list_agent_ideas(
    ...
    stage: Optional[str] = Query(None, description="raw / validated / staked / implement / rejected"),
):
    """List ideas surfaced by the research pipeline, most recent first."""
    from .research_agent import list_ideas
    return list_ideas(limit=limit, status=status, market_type=market_type, stage=stage)
